...
mocha.Suite.prototype.fullTitle = function() {
  ...
  if (this.tags && Object.keys(this.tags).length) {
    this.title += TAGS_PREFIX + Object.keys(this.tags).join(TAGS_SUFFIX + TAGS_PREFIX) + TAGS_SUFFIX;
  }
...
mocha.Runner.prototype.grep = function(re, invert) {
  ...
  try {
    ...
    throw new Error('Invalid filter: ' + filterStr + ' [' + err.description + ' at character ' + err.index + ']');
  }
