...
module.exports = function(suite){
  ...
  suite.on('pre-require', function(context, file, mocha) {
     ...
     * and be enqueued in the WebDriver Control Flow. Those functions can still be
     * called with a callback function to use according to the continuation pattern.
     *
     * @param module
     */
